    ...
    const onMove = (e: MouseEvent) => {
      ...
      if (el) {
        ...
        if (rgb && !(rgb[0] === 0 && rgb[1] === 0 && rgb[2] === 0)) {
          ...
          const inv: [number, number, number] = [255 - rgb[0], 255 - rgb[1], 255 - rgb[2]];
          ...
          ring.style.boxShadow   = "0 0 10px var(--neon-cyan), inset 0 0 10px rgba(0,245,255,0.08)";
...
export default function RootLayout({ children }: PropsWithChildren) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={cn("bg-[var(--bg-primary)] overflow-y-scroll overflow-x-hidden", outfit.className)}>
        <ThemeProvider>
