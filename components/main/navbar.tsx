    ...
    >
      ...
      <span
        ...
        style={{
          ...
          background: theme === "dark" ? "var(--neon-cyan)" : "var(--accent-primary)",
          boxShadow: theme === "dark" ? "0 0 8px var(--neon-cyan)" : "0 0 8px var(--accent-primary)",
        }}
      />
    </button>
  );
...
export const Navbar = () => {
  ...
  // Separate refs: one for the panel, one for the hamburger button
  ...
  useEffect(() => {
    ...
    // Use timeout so this handler doesn't fire on the same click that opened the menu
    ...
    <>
      <nav
        ...
        style={{
          ...
          boxShadow: "0 4px 40px rgba(0,0,0,0.4), 0 1px 0 var(--border-subtle)",
        }}
      >
        {/* Neon top line */}
        <div
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      color: isActive ? "var(--neon-cyan)" : activeLink === link.title ? "var(--text-primary)" : "var(--text-secondary)",
                      textDecoration: "none",
            ...
            <a href="/contact">
              ...
              >
                <span
                  ...
                  style={{ background: "var(--neon-green)", boxShadow: "0 0 6px var(--neon-green)", animation: "blink 2s ease-in-out infinite" }}
                />
                <span style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--neon-green)", letterSpacing: "0.12em" }}>
                  HIRE ME
                </span>
              </div>
            </a>
            ...
            >
              {[0, 1, 2].map((i) => (
                <span
                  ...
                  style={{
                    width: i === 1 ? (isMobileMenuOpen ? "0px" : "14px") : "20px",
                    background: "var(--neon-cyan)",
                    boxShadow: "0 0 4px var(--neon-cyan)",
                    transform:
                      i === 0 && isMobileMenuOpen ? "translateY(6.5px) rotate(45deg)"
                      : i === 2 && isMobileMenuOpen ? "translateY(-6.5px) rotate(-45deg)"
                      : "none",
      ...
      {isMobileMenuOpen && (
        <div
          ...
          style={{ background: "rgba(2,0,8,0.6)", backdropFilter: "blur(4px)" }}
          onClick={closeMenu}
        />
      )}

      {/* Menu panel — separate from backdrop so ref is accurate */}
      <div
        ref={menuPanelRef}
        className="fixed top-[65px] left-4 right-4 z-50 md:hidden rounded-2xl overflow-hidden transition-all duration-500"
        style={{
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-2">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-mono)", fontSize: "10px", color: "var(--text-muted)", letterSpacing: "0.1em" }}
          >
            &lt;/RAHUL_ROY&gt;
          </p>
        </div>
